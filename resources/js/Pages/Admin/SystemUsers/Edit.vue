...
const isStep1Valid = computed(() => {
    const basicInfo = form.first_name.trim() !== '' && 
                      form.last_name.trim() !== '' && 
                      form.email.trim() !== '';
    
    // Only check password if entered
    const passwordValid = form.password === '' || (form.password.length >= 8 && form.password === form.password_confirmation);
    
    return basicInfo && passwordValid;
});
...
const submit = () => {
    form.put(route('admin.system-users.update', { user: props.user.id }), {
        onSuccess: () => {
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="bg-gray-50 border-b border-gray-100 p-8">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            <h1 class="text-2xl font-bold text-gray-900">Edit System User</h1>
                            <p class="text-gray-500 mt-1">Update details for {{ user.first_name }} {{ user.last_name }}</p>
                        </div>
                ...
                <div class="p-8 min-h-[400px]">
                    ...
                    <div v-show="currentStep === 1" class="space-y-6 max-w-2xl mx-auto animation-fade-in">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-gray-500">Update specific personal details.</p>
                        </div>
                        ...
                        <div class="bg-yellow-50 border border-yellow-100 rounded-xl p-4 mt-4">
                            <h4 class="font-bold text-yellow-800 text-sm mb-2"><i class="fa-solid fa-key mr-2"></i>Change Password</h4>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-xs font-medium text-gray-600 mb-1">New Password (leave blank to keep current)</label>
                                    <input 
                                        v-model="form.password"
                                        type="password" 
                                        placeholder="Enter new password"
                                        class="w-full px-4 py-2 rounded-lg border-gray-200 focus:ring-indigo-500 focus:border-indigo-500 shadow-sm text-sm"
                    ...
                    <div v-show="currentStep === 2" class="space-y-6 max-w-2xl mx-auto animation-fade-in">
                        <div class="text-center mb-8">
                            ...
                            <p class="text-gray-500">Update role assignment and status.</p>
                        </div>
                    ...
                    <div v-show="currentStep === 3" class="max-w-2xl mx-auto animation-fade-in">
                        <div class="text-center mb-8">
                            <h2 class="text-xl font-bold text-gray-900">Review & Update</h2>
                            <p class="text-gray-500">Confirm changes before saving.</p>
                        </div>
                        ...
                        <div class="bg-white border border-gray-200 rounded-2xl overflow-hidden mb-6">
                            ...
                            <div class="p-6 border-b border-gray-100">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div v-if="form.password" class="col-span-2 bg-yellow-50 p-2 rounded text-xs text-yellow-700">
                                        <i class="fa-solid fa-key mr-1"></i> New password set
                                    </div>
                                </div>
                            </div>
