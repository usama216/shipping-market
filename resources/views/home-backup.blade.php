        ...
        <div class="max-width-container">
            ...
            <div class="hero-heading-and-content-outer">
                <div class="hero-heading-and-content-inner">
                    <h1>
                        Get Your <span>USA</span> and <span>UK</span> Shipping Address for
                        the Dutch Caribbean
                    </h1>
                    <p>
                        Shop on any online store using your unique and personal Marketsz
                        USA and UK Shipping Address and we deliver your orders to your
    ...
    <section class="hassle-free-solution-outer">
        <div class="max-width-container">
            ...
            <div class="hf-destination-card hf-destination-card-1">
                ...
                <span class="hf-rectangle-text hf-rectangle-text-1">Get a USA and UK shipping address</span>
    ...
    <section class="mbl-hassle-free-solution-outer">
        ...
        <div class="mbl-hf-destination-cards-container">
            <div class="mbl-hf-destination-card mbl-hf-destination-card-1">
                ...
                <span>Get a USA and UK shipping address</span>
            </div>
            ...
            <section class="how-much-cost-outer">
                <div class="how-much-cost-inner">
                    ...
                    <div class="get-price-btn-container">
                        <button class="get-price-btn">Get Price Estimate</button>
                    </div>
                </div>
    ...
    <section class="where-can-i-shop-outer">
        <div class="max-width-container">
            ...
            <section class="where-can-i-shop-inner">
                ...
                <p>
                    Marketsz works with all online stores that ship to the US and
                    Europe. When shopping online simply use your personal US Marketsz
    ...
    <section class="free-benifits-outer">
        <div class="max-width-container">
            ...
            <div class="fb-text-passage fb-text-passage-3">
                <p>
                    <span>Free 30-Day Storage:</span> No rush to ship? No worries! We'll
...
@section('script')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            // slider images logic
            // PL = Partners Logos
            const PL_BASE_URL = @json(asset('assets/images/partners-logos/')) + '/';
            const allImages = [
                "aliexpress-logo.png",
                "amazon-logo.png",
                "apple-logo.png",
